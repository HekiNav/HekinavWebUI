...
const endpoint = ref(localStorage.getItem("hekinav.endpoint") || "https://api.digitransit.fi/routing/v2/finland/gtfs/v1")
...
function planRoute() {
  ...
  localStorage.setItem("hekinav.endpoint", endpoint.value)
        ...
        <div class="options">
          ...
          <div title="option-1" class="option-container">
            <input id="option-1" name="option" type="radio"
              :checked="endpoint == 'https://api.digitransit.fi/routing/v2/finland/gtfs/v1'" />
          ...
          <div title="option-2" class="option-container">
            <input id="option-2" name="option" type="radio"
              :checked="endpoint == 'https://api.digitransit.fi/routing/v2/hsl/gtfs/v1'" />
            <label class="option" for="option-2" data-txt="HSL&nbsp;v2"
              @click="endpoint = 'https://api.digitransit.fi/routing/v2/hsl/gtfs/v1'"></label>
          </div>
          <img class="digitransit-logo" src="../assets/img/hekinav_white.png" alt="Hekinav">
          <div title="option-3" class="option-container">
            <input id="option-3" name="option" type="radio" :checked="endpoint == 'N/A'" />
            <label class="option" for="option-3" data-txt="Hekinav N/A" @click="endpoint = 'N/A'"></label>
          </div>
        </div>
      </div>
