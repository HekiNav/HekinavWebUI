...
sidebarMode('main')
JsonImport('hsl.json', importedData => addZones(importedData))
JsonImport("searchParameters.json", data => addParameters(data[document.getElementById("apiSelect").value]))
